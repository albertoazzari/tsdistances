                ...
                pub mod $name {
                    ...
                    impl GpuKernelImpl for $impl_struct {
                        fn dispatch(
                            ...
                            b_len: u64,
                            max_subgroup_threads: u64,
                            a: vulkano::buffer::Subbuffer<[f32]>,
                            b: vulkano::buffer::Subbuffer<[f32]>,
                            diagonal: vulkano::buffer::Subbuffer<[f32]>,
                        ) {
                            single_call::builder()
                                .unwrap()
                                .build(device)
                    ...
                    fn batch_call(
                        ...
                        $(param3: $ty3,)?
                        $(param4: $ty4,)?
                        $(#[global] vec5: vulkano::buffer::Subbuffer<$ty5>,)?
                        #[global] $a: vulkano::buffer::Subbuffer<[f32]>,
                        #[global] $b: vulkano::buffer::Subbuffer<[f32]>,
                        #[global] diagonal: vulkano::buffer::Subbuffer<[f32]>,
                    ) {
                        use krnl_core::buffer::UnsafeIndex;
                        use krnl_core::num_traits::Float;
